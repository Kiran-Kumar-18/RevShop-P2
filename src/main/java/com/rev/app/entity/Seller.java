...
public class Seller {
    ...
    public static class SellerBuilder {
        ...
        @java.lang.SuppressWarnings("all")
        public Seller.SellerBuilder totalRevenue(final java.math.BigDecimal totalRevenue) {
        ...
        public Seller build() {
            return new Seller(this.sellerId, this.user, this.businessName, this.gstNumber, this.address, this.createdAt, this.totalRevenue);
        }
    ...
    public Seller(final Integer sellerId, final User user, final String businessName, final String gstNumber, final String address, final LocalDateTime createdAt, final java.math.BigDecimal totalRevenue) {
        this.sellerId = sellerId;
        this.user = user;
        this.businessName = businessName;
        this.gstNumber = gstNumber;
